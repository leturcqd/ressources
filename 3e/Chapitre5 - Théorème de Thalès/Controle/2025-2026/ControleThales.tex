...
\textbf{Partie A : étude géométrique du terrain - 9 points (2+5+2)}
...
\item L'agriculteur souhaite semer le mélange de graines sur la partie du champ représentée par le triangle CDE dont l'aire mesure {48~600}~m$^2$. Calculer la quantité de blé nécessaire pour cette surface.
...
L'agriculteur dispose-t-il d'un budget suffisant pour acheter le blé, le seigle et les pois ?
\end{enumerate}
