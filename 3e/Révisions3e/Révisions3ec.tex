...
\item Partie \ref{calc}, de 1 à 81 sur 108
...
x &=& \frac{-16}{-8}
\end{eqnarray*}
On trouve alors $x=+2$ après simplification de la fraction. 
...
x &=& \frac{129}{-43}
\end{eqnarray*}
On trouve alors $x=-3$ après simplification de la fraction (car $129=43\times3$). 
...
x &=& -\frac{21}{5}
\end{eqnarray*}
On trouve alors $x=-\frac{21}{5}$ (ou $x=-4,2$).
