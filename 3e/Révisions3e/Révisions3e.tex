...
Je vous ai rédigé ces exercices (\url{https://www.leturcqd.github.io/ressources/3e/R\%C3\%A9visions3e/R\%C3\%A9visions3e.pdf}) comme une base de travail pour ceux qui veulent se renforcer un peu avant le lycée, et aussi pour ceux qui sont en recherche de problèmes plus intéressants. \\La première partie comporte des exercices de calcul pur sur le programme de collège : quatre opérations sur les relatifs et les fractions, manipulations des signes et des parenthèses, calcul littéral (réduction, distributivité)\footnote{Cela manque de factorisations, il faudra que je vous en rajoute en v2.}, résolution d'équations.
...
Si j'en trouve le temps, je vous ajouterai des corrections de tout cela dans quelques temps au lien suivant : \url{https://www.leturcqd.github.io/ressources/3e/R\%C3\%A9visions3e/R\%C3\%A9visions3ec.pdf}
