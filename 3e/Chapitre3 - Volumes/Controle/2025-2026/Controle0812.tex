...
\subsection*{Exercice 1 - 4 points}	%(1 + 1 + 1 + 1) 
...
\item Un cône de rayon $2$ cm et de hauteur $3$ cm. 
...
\subsection*{Exercice 2, 11 points}  %=  3+ 1 + 1 + 3 + 2 + 1,5+1,5

\begin{center}\includegraphics[scale=.4]{Exo3}\end{center}

\begin{enumerate}
\item Montrer que la longueur $DF$ est de $3,9$ m (on arrondira au dm).
\item Calculer la longueur $AD$. 
\item Démontrer que les droites $(AB)$ et $(DC)$ sont parallèles. 
\item Calculer la longueur $AB$. On arrondira au mètre. 
\item Calculer en mètres-cube, puis en litres, le volume de la cuve $ABCDIJGH$. 
\item Exprimer également en litres le volume de la zone $ABGJKF$ située entre le toit et la cuve.
\end{enumerate}

\subsection*{Exercice 3 - 5 points}
%
\includegraphics[width=19cm]{Exo_perles}
%
