...
\[ -1  + 3 + 2 + (-4) + (-5) + 6  =  {\color{red} (3+2+6) - (1+4+5) = 11-10=1  }\]
\[ (-1  + 3 + 4) - ((-4) + (-7) + 6 ) ={\color{red}   6 - (-5) = 11} \]
\[ -1  - ( 3 + 2 + (-4) ) - ((-5) + 6)=
{\color{red} - 1 - 1 - 1 = -3  }
 \]
\[ 1,03  + 3,4 + 6 + (-4,13)   + (-5,4) + 2,1 ={\color{red}    12,53-9,53 = 3 }\]
...
\draw (0,0)  node {{\color{red}  9 }};
\draw(-1,-1) node {{\color{red}  8 }} ++(2,0) node {{\color{red}  1 }};
\draw(-2,-2) node {{\color{red}  6,5 }} ++(2,0) node {{\color{red}  1,5 }} ++(2,0) node {{\color{red} -0,5  }};
\draw(-3,-3) node {\phantom{}{7,5}} ++(2,0) node {\phantom{}{-1}} ++(2,0) node {\phantom{}{2,5}} ++(2,0) node {\phantom{}{-3}};
\end{tikzpicture}
\
\begin{tikzpicture}[scale=.9,every node/.style={draw,minimum width=1.8cm,minimum height=.9cm}]
\draw (0,0)  node {{\color{red}  2,7 }};
\draw(-1,-1) node {{\color{red} 1,2  }} ++(2,0) node {\phantom {}{1,5}};
\draw(-2,-2) node {{\color{red}  1,8 }} ++(2,0) node {\phantom{}{-0,6}} ++(2,0) node {{\color{red} 2,1  }};
\draw(-3,-3) node {\phantom{}{4,1}} ++(2,0) node {\phantom{}{-2,3}} ++(2,0) node {{\color{red}  1,7 }} ++(2,0) node {{\color{red}0,4}};
\end{tikzpicture}
\end{figure}
...
\ 
\begin{tikzpicture}[scale=.9,every node/.style={draw,minimum width=1.8cm,minimum height=.9cm}]
\draw (0,0)  node {{\color{red}  0 }};
\draw(-1,-1) node {-5,9} ++(2,0) node {{\color{red}   5,9}};
\draw(-2,-2) node {{\color{red} -5,7}} ++(2,0) node {-0,2} ++(2,0) node {{\color{red}6,1}};
\draw(-3,-3) node {2,4} ++(2,0) node {{\color{red} -8,1}} ++(2,0) node {{\color{red}7,9}} ++(2,0) node {-1,8};
\end{tikzpicture}
\end{figure}
...
\[
\begin{TAB}(e,1cm){|c|c|c|c|}{|c|c|c|c|}
    -2 & {\color{red} 10  }&{\color{red} -7  } & 5 \\
	5 & {\color{red} 0  } & {\color{red} 2  } & {\color{red}  -1 } \\
      {\color{red} 1  }& -3 & 7 & {\color{red} 1  }\\
     2 & -1 &  {\color{red}  4 }& 1
\end{TAB}
\]
