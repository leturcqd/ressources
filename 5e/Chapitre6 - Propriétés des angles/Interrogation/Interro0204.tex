...
\item  Déterminer la mesure de l'angle $\widehat{JUW}$.\item  En déduire la mesure de l'angle $\widehat{UWJ}$.\item  Déterminer si les droites $(JW)$ et $(ID)$ sont parallèles. \end{enumerate}
	...
	\draw [color={black}] (-2.5,3) node[anchor = center,scale=1, rotate = 0] {D};
	\draw [color={black}] (9.5,3.95) node[anchor = center,scale=1, rotate = 0] {E};
...
\item  Calculez la somme des angles du quadrilatère $CRSX$. \end{enumerate}
