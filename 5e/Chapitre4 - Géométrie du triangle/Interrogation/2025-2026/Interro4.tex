...
\begin{center}{\Large Interrogation chapitre 4}\\ 
 ...
 \begin{enumerate}
 \item Énoncer la \textbf{\underline{définition}} précise de la médiatrice du segment $[AB]$. 
 \item Quelle \textbf{\underline{propriété}} caractérise les points de cette médiatrice ?
 \end{enumerate}
 
 \subsection*{Exercice 2 (6 points)}
 
Pour chacun des triplets de longueurs suivants, dire s'il permet de construire un triangle, en justifiant votre réponse. Quand la réponse est positive, construire ledit triangle.
\begin{enumerate}
